...
{
    SALVATION_ASSERT_MSG(m_NextIndex < m_Lookup.Capacity(), "PackedArray<T>::Add: Capacity overflow.");
...
{
    SALVATION_ASSERT_MSG(m_NextIndex > 0, "PackedArray<T>::Remove: Removing from empty array");
